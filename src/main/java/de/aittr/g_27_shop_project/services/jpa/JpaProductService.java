...
import de.aittr.g_27_shop_project.exeption_handling.exeptions.ThirdTestException;
...
//    private Logger logger = (Logger) LoggerFactory.getLogger(JpaProductService.class);
    ...
    public ProductDto save(ProductDto product) {
        try {
            JpaProduct entity = mappingService.mapDtoEntity(product);
            entity.setId(0);
