...
import de.aittr.g_27_shop_project.exeption_handling.exeptions.FirsTestException;
...
public class ProductController {
    ...
    public ProductDto getById(@PathVariable int id) {
        ...
        if(dto == null) {
            throw  new FirsTestException("Продукт с указанным ИД отсутствует в БД");
        }
        return dto;
    }
    ...
    @ExceptionHandler(FirsTestException.class)
    @ResponseStatus(HttpStatus.I_AM_A_TEAPOT)
    public Response handleException(FirsTestException e ) {
